<%@ Page Title="Surplus Rush - EcoEats"
    Language="C#"
    MasterPageFile="~/Site.Master"
    AutoEventWireup="true"
    CodeBehind="Game.aspx.cs"
    Inherits="Business_App_Dev.Game" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style>
        body { background: #f4efe6; font-family: 'Inter', Arial, sans-serif; margin: 0; }

        .g-wrap { max-width: 900px; margin: 0 auto; padding: 22px 14px 60px; }
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        (() => {
            ...
            const hfFinalized = document.getElementById("<%= hfFinalized.ClientID %>");

            const locked = (hfLocked && hfLocked.value === "1");
            const alreadySaved = (hfFinalized && hfFinalized.value === "1"); // optional if you set it server-side
            ...
            if (alreadySaved) {
                ...
                btnWaste.disabled = true;
                endPanel.style.display = "block";
                endTitle.textContent = "✅ Already Saved";
                endText.innerHTML = "Your result is already saved for today.";
                window.openResultModal("✅ Already Saved", "Your result is already saved for today.");
                return;
            }
