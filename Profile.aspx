<%@ Page Title="EcoEats - Profile"
    Language="C#"
    MasterPageFile="~/Site.Master"
    AutoEventWireup="true"
    CodeBehind="Profile.aspx.cs"
    Inherits="Business_App_Dev.Profile" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <!-- ✅ Surplus Rush banner styles + password styles -->
    <style>
        /* ========================= */
        /* 🎮 SURPLUS RUSH BANNER     */
        /* ========================= */
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Keep ScriptManager here (like your Product.aspx) -->
   ...
   <section class="ee-hero"
    ...
    <div class="ee-container">
        <h1 style="color:#fff; font-weight:800; font-size:48px; margin:0;">
            Surplus Rush
        </h1>
    </div>
</section>
